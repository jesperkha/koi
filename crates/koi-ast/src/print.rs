use crate::nodes::{
    Ast, BlockNode, ElseBlock, FuncNode, ReturnNode, Stmt, TypeNode, Visitable, Visitor,
};
...
impl Visitor<()> for Printer {
    ...
    fn visit_call(&mut self, node: &crate::nodes::CallExpr) {
    ...
    fn visit_group(&mut self, node: &crate::nodes::GroupExpr) {
        self.s.push('(');
        node.inner.accept(self);
        self.s.push(')');
    }

    fn visit_extern(&mut self, node: &crate::nodes::FuncDeclNode) {
        for m in &node.modifiers {
            self.s += &format!("@{}\n", m.modifier);
        }
    ...
    fn visit_var_decl(&mut self, node: &crate::nodes::VarDeclNode) {
        self.s.push_str(&format!("{} {} ", node.name, node.symbol));
        node.expr.accept(self);
    }

    fn visit_var_assign(&mut self, node: &crate::nodes::VarAssignNode) {
        node.lval.accept(self);
        self.s.push_str(" = ");
        node.expr.accept(self);
    }

    fn visit_import(&mut self, node: &crate::nodes::ImportNode) {
    ...
    fn visit_member(&mut self, node: &crate::nodes::MemberNode) {
        node.expr.accept(self);
        self.s.push('.');
        self.s.push_str(&node.field.to_string());
    }

    fn visit_binary(&mut self, node: &crate::nodes::BinaryExpr) {
    ...
    fn visit_unary(&mut self, node: &crate::nodes::UnaryExpr) {
        self.visit_literal(&node.op);
        node.rhs.accept(self);
    }

    fn visit_if(&mut self, node: &crate::nodes::IfNode) {
        self.s += "if ";
        node.expr.accept(self);
        self.s += " ";
    ...
    fn visit_while(&mut self, node: &crate::nodes::WhileNode) {
        self.s += "while ";
        node.expr.accept(self);
        self.s += " ";
        self.visit_block(&node.block);
    ...
    fn visit_break(&mut self, _: &crate::nodes::BreakNode) {
        self.s += "break"
    }

    fn visit_continue(&mut self, _: &crate::nodes::ContinueNode) {
        self.s += "continue"
    }

    fn visit_for(&mut self, node: &crate::nodes::ForNode) {
        self.s += "for ";
    ...
    fn visit_type_decl(&mut self, node: &crate::nodes::TypeDeclNode) {
        if node.public {
            self.s += "pub "
        }
        if node.unique {
    ...
    fn visit_cast(&mut self, node: &crate::nodes::CastExpr) {
        node.expr.accept(self);
        self.s += " as ";
        node.ty.accept(self);
    }

    fn visit_op_assign(&mut self, node: &crate::nodes::OpAssignNode) {
        node.lval.accept(self);
